...
class ShapeGenerator {
	...
	constructor() {
	  ...
	  this.shapeContainer = document.getElementById('shape-container') as HTMLDivElement;
	  this.errorMessage = document.getElementById('error-message') as HTMLDivElement;
  
	  this.generateButton.addEventListener('click', this.generateButtonClick.bind(this));
	  this.sizeInput.addEventListener('keydown', this.sizeInputKeyDown.bind(this));
	}
